...
| Max (Const(3), Const(2)) => 3
| Max (Const(2), Const(3)) => 3
| Minus (Const(0), Const(0)) => 0
| Minus (Const(1), Const(0)) => 1
| Minus (Const(0), Const(1)) => 0
| Minus (Const(2), Const(1)) => 1
| Minus (Const(3), Const(2)) => 1
| Minus (Const(3), Const(1)) => 2
} = ?
